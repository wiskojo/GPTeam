...
3. Browse Website: "browse_website", args: "url": "<url>", "goal": <string> // Browse the website at the url. Provide a description of the goal if you're looking for something specfic from the website.
