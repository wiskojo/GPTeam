...
# 0. No-op, do nothing: "noop", args:
# 1. Message user: "message_user", args: "message": "<string>"
# 2. Create agent: "create_agent",  args: "name": <name>, "task": "<short_task_desc>", "prompt": "<prompt>"